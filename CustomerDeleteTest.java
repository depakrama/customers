...
public class CustomerDeleteTest extends FunctionalTestCase {
		...
		public void setup()
		{
			...
			DefaultMuleMessage request = new DefaultMuleMessage("deleteCustomer", null, null, null, muleContext); 
			HttpRequestOptions options = HttpRequestOptionsBuilder.newOptions()
					.method(HttpConstants.Methods.DELETE.name())
					.build();
	...
	public void getValidCustomerTest() throws Exception {
		...
		assertTrue( (responsePayload.length() > 0) && httpStatus.intValue() == 204);
	}
